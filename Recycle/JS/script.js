...
let testimonials = $(".testimonials").offset().top;
$(window).scroll(function () {
    let windowScroll = $(window).scrollTop();
    if (windowScroll > whyOffset - 200 && windowScroll < testimonials) {
        $(".green").animate({ width: "76%" }, 250, function () {
            $(".orange").animate({ width: "70%" }, 250, function () {
                $(".green2").animate({ width: "35%" }, 250, function () {
                    $(".blue").animate({ width: "55%" }, 250);
                });
            });
        });
    }
    /*else if (windowScroll < whyOffset || windowScroll > testimonials){
         $(".green").animate({ width: "1%" }, 150, function () {
             $(".orange").animate({ width: "1%" }, 150, function () {
                 $(".green2").animate({ width: "1%" }, 150, function () {
                     $(".blue").animate({ width: "1%" }, 150);
                 });
             });
         });
     }*/
